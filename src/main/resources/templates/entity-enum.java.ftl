...
<#list table.fields as field>
    ...
    public String get${field.propertyName?cap_first}Comment() {
        return ${entity}Constant.${field.propertyName?cap_first}.comment(this.${field.propertyName});
    }

    /**
     * @param ${field.propertyName} {@link ${package.Constant}.${entity}Constant.${field.propertyName?cap_first}}
     */
    public boolean is${field.propertyName?cap_first}Equals(${entity}Constant.${field.propertyName?cap_first} ${field.propertyName}) {
        return Objects.equals(this.${field.propertyName}, ${field.propertyName}.getValue());
    }
